export const ACTION_DESCRIPTIONS = {
  fly_to_location: {
    description:
      "Fly the SITREP camera to a known city, geocoded country/region/city/landmark, or explicit WGS84 coordinate. Countries/cities frame the whole place; landmarks/buildings use close framing.",
    $position: 1,
    parameters: {
      properties: {
        locationId: {
  ...
  set_layer_visibility: {
    description: "Enable or disable one registered SITREP data layer.",
    $position: 1,
    parameters: {
      properties: {
        layerId: {
  ...
  set_visual_style: {
    description: "Set the active SITREP visual filter/style.",
    $position: 1,
  },
  get_entity_context: {
    description:
