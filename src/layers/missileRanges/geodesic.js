 ...
 * @param {{lat: number, lon: number, radiusKm: number, pointCount?: number, heightM?: number}} options
 ...
 *   for label placement.
 */
export function buildGeodesicRing({
  lat,
  lon,
  radiusKm,
  pointCount = 180,
  ...
  for (let i = 0; i <= pointCount; i++) {
    ...
    positions.push(Cesium.Cartesian3.fromDegrees(ptLon, ptLat, heightM));
