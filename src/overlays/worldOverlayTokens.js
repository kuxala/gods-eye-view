...
export const WORLD_OVERLAY_STYLE = Object.freeze({
  ...
  selectedBackground: 'rgba(24, 5, 5, 0.94)',
  border: 'rgba(223, 213, 209, 0.18)',
  selectedBorder: 'rgba(194, 176, 168, 0.72)',
  title: 'rgba(241, 237, 235, 0.96)',
  detail: 'rgba(173, 155, 147, 0.92)',
  leader: 'rgba(200, 183, 175, 0.58)',
  accent: '#c2b0a8',
  ...
  anchorDotStroke: 'rgba(16, 4, 4, 0.96)',
  leaderWidth: 1.35,
});
...
export const CCTV_THUMBNAIL_STYLE = Object.freeze({
  ...
  titleColor: 'rgba(232, 225, 222, 0.95)',
  titleFont: '600 10px "JetBrains Mono", monospace',
  accent: 'rgb(194, 176, 168)',
  leader: 'rgba(194, 176, 168, 0.6)',
  rule: 'rgba(194, 176, 168, 0.95)',
  ruleHeight: 2,
  radius: 4,
});
...
export const DETECTION_THEME_MAP = Object.freeze({
  ...
  _default: {
    line: 'rgba(255, 0, 0, 0.9)',
    label: 'rgba(232, 226, 223, 0.97)',
    labelBg: 'rgba(26, 2, 2, 0.66)',
    calloutPlate: 'rgba(26, 2, 2, 0.46)',
    calloutPlateSpace: 'rgba(26, 2, 2, 0.54)',
    glow: 'rgba(255, 0, 0, 0.4)',
    dim: 'rgba(196, 177, 169, 0.66)',
