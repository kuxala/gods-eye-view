...
import { flyToHormuz } from '../camera.js';
...
export function createApplicationControls({
  ...
  // If no share link state, do default fly-to Hormuz
  if (!styleManager.hasShareState) {
    loaderStatus.textContent = 'Flying to the Strait of Hormuz...';
    defer(flyToHormuz(viewer));
  } else {
